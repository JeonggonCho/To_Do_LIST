...
- 미니 프로젝트 : 간편하게 할 일을 생성 및 관리 할 수 있는 웹페이지를 Django를 사용하여 제작
...
- 문제점
    ...
    : modal을 통해 할 일을 생성하거나 할 일을 단일 조회하거나 수정하는 기능을 구현해보고 싶었다.

<br>

- 해결방법(1)

    - views.py에서 각 기능의 form을 content를 통해 html로 리턴하고, modal의 body에 `Django Template Language(DTL)` {{ form }}을 넣어 출력하도록 한다.
